...
class App extends Component {
  ...
  rentMovie = (movieId) => {
    const movies = [...this.state.movies];
    const movieIndex = movies.findIndex((m => m.id === movieId));
    movies[movieIndex].isRented = true;
    this.setState({
      movies
    })
    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route path="/catalog" exact component={() => <Catalog currentUser={this.getCurrentUser()} movies={state.movies} returnMovie={this.returnMovie} rentMovie={this.rentMovie}/>} />
